...
export class PdfParserService {
  ...
  async parsePdf(file: File): Promise<ParsedSong[]> {
    ...
    // Absolute URL avoids iOS Safari resolving the relative path against the
    // module script URL instead of the document URL when running inside a
    ...
    // where arrayBuffer() can silently fail or return an empty buffer.
